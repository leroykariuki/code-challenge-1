...
var taxablePay = grossSalary - personalRelief - insuranceRelief - allowablePensionFundContribution - allowableHOSPContribution 
var paye = 0;
...
if (grossSalary <= nssfTier1Limit) {
  ...
  nssfDeductions = nssfTier1Limit * nssfTier1Rate + (grossSalary - nssfTier1Limit) * nssfTier2Rate;
}
